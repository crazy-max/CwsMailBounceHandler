...
class CwsMailBounceHandler
{
    ...
    private function processMailParsing($token, $content)
    {
        ...
        if ($isFbl) {
            ...
            $cwsMbhRecipient = new CwsMbhRecipient();
     ...
     * @param CwsMbhMail $cwsMbhMail : mail bounce object.
     * @return boolean
     */
    private function processMailDelete(CwsMbhMail $cwsMbhMail)
    {
        if ($this->isMailboxOpenMode()) {
     ...
     * @return boolean
     */
    private function processMailMove(CwsMbhMail $cwsMbhMail)
    {
        if ($this->isMailboxOpenMode()) {
     ...
     * @param boolean $create : whether or not to create the mailbox if not found, defaults to true
     * @return boolean
     */
...
class CwsMbhResult
{
    ...
    {
        $this->counter = new CwsMbhCounter();
        $this->mails = array();
    }
    
    public function getCounter()
    {
        if ($this->counter instanceof CwsMbhCounter) {
            return $this->counter;
        }
        return null;
    }

    public function setCounter(CwsMbhCounter $counter)
    {
    ...
    public function addMail(CwsMbhMail $mail)
    {
        $this->mails[] = $mail;
    }
}
...
class CwsMbhMail
{
    ...
    /**
     * List of recipients, see CwsMbhRecipient object
     * @var array
     */
    private $recipients;
    ...
    public function addRecipient(CwsMbhRecipient $recipient)
    {
        $this->recipients[] = $recipient;
    }
}

class CwsMbhRecipient
{
    /**
    ...
    /**
     * Bounce type (see BOUNCE_ const in CwsMailBounceHandler)
     * @var string
     */
    private $bounceType;
    
    /**
     * Bounce category (see CAT_ const in CwsMailBounceHandler)
     * @var string
     */
    private $bounceCat;
    ...
    public function __construct()
    {
        ...
        $this->email = null;
        $this->bounceCat = null;
        $this->bounceCat = CwsMailBounceHandler::CAT_UNRECOGNIZED;
        $this->remove = false;
    }
